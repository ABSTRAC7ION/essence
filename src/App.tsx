...
function App() {
  const items = [
    ...
    },
    {
      ...
      imgLink:
        "https://prosafety.com/9003-thickbox_default/work-trousers-denim-flexiwork--6956--short-legs.jpg",
    },
  ];
            ...
            {items.map((item) => (
              ...
              >
                <img
                  ...
                  className="aspect-square w-full h-80 object-cover hover:scale-[105%] ease-in-out duration-500"
                />
